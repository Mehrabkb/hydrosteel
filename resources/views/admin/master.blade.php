...
{{--            <!-- Message Start -->--}}
{{--            <div class="media">--}}
{{--              <img src="{{ asset('assets/adminlte') }}/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 ml-3 img-circle">--}}
...
{{--            <!-- Message Start -->--}}
{{--            <div class="media">--}}
{{--              <img src="{{ asset('assets/adminlte') }}/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle ml-3">--}}
{{--              <div class="media-body">--}}
{{--                <h3 class="dropdown-item-title">--}}
{{--                  پیمان احمدی--}}
...
{{--            <!-- Message Start -->--}}
{{--            <div class="media">--}}
{{--              <img src="{{ asset('assets/adminlte') }}/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle ml-3">--}}
{{--              <div class="media-body">--}}
{{--                <h3 class="dropdown-item-title">--}}
{{--                  سارا وکیلی--}}
...
{{--          </div>--}}
          <div class="info">
            <a href="#" class="d-block">هیدرواستیل</a>
          </div>
        </div>
...
{{--            </li>--}}
            <li class="nav-item">
              <a href="{{ route('admin.factor') }}" class="nav-link">
              ...
              <li class="nav-item">
                  <a href="{{ route('admin.step') }}" class="nav-link">
                      <i class="nav-icon fa fa-th"></i>
                      <p>
مراحل
                      </p>
...
<footer class="main-footer">
    <strong>CopyLeft &copy; 2024 <a href="https://behinava.net">بهین آوا</a>.</strong>
  </footer>
